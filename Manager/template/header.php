<?php 
 session_start();
 $role = $_SESSION['role'];
 if(!isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] !== true && $role !== "manager"){
                        ...
                        <ul id="dashboard" class="active active-menu" data-parent="#iq-sidebar-toggle">
                           ...
                           <li>
                              ...
                              <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                                 <li><a href=""><i class="las la-th-list"></i>Student List</a></li>
                                  <li><a href=""><i class="las la-th-list"></i>Employee List</a></li>
                              </ul>
                           </li>
                            <li>
